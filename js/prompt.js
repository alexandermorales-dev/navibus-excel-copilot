...
DEGRADACIÓN GRACIAL (CRÍTICO): Si no logras construir el panel completo con gráficos y formato elaborado, NO te rindas ni respondas solo con texto. Como MÍNIMO absoluto, crea una hoja nueva y escribe una TABLA RESUMEN con los datos que el usuario pidió, usando fórmulas que referencian las celdas fuente. Una tabla simple con encabezados y totales SIEMPRE es mejor que ninguna salida. Prioriza: 1) tabla con los datos solicitados, 2) formato básico (bold headers, borders), 3) KPIs simples, 4) gráficos. Si llegas a los KPIs pero no a los gráficos, entrega los KPIs. Si llegas a la tabla pero no a los KPIs, entrega la tabla. NUNCA termines una construcción sin haber escrito ALGO en una hoja nueva.
